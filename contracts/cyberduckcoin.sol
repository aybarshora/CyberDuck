...
contract CyberDuckCoin is IERC20, Ownable {
    ...
    event SentToStaking(uint amount);
    ...
    function getMinHoldingAmount() public view returns (uint256) {
    ...
    function totalSupply() public pure override returns (uint256) {
        return 400000000000000 * 10 ** decimals();
    }
    ...
    function setStakingContract(address _stakingContract) external onlyOwner {
        ...
        emit SetStaking(_stakingContract);
    }

    function setMarketingAddress(address _marketingAddress) external onlyOwner {
        marketingAddress = _marketingAddress;
        emit SetMarketing(_marketingAddress);
    }
    ...
    function _transfer(
        ...
        uint256 amountToStaking = (amount * 7) / 1000; // 0.7% = 7 / 1000
        uint256 amountToMarketing = (amount * 5) / 1000; // 0.5% = 5 / 1000

        //buy and sell fees

        if (sender == uniswapV2Pair || recipient == uniswapV2Pair) {
            _balances[stakingContract] += amountToStaking;
            _balances[marketingAddress] += amountToMarketing;
            amount -= (amountToMarketing + amountToStaking);
        }
